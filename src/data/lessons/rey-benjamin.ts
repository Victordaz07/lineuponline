      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Mosíah 2:14-15', text: 'Y ni aun os he permitido que me sirvierais ni que dependierais de mí; y que os he servido con mis propias manos, que podáis testificar... Y si yo, a quien llamáis vuestro rey, quien ha pasado sus días en vuestro servicio, y sin embargo ha sido de vuestro servicio, os doy gracias, ¿cuánto más debéis dar gracias a vuestro Padre celestial?' },
            { type: 'paragraph', text: 'Benjamín gobernó sin cobrar tributo — una anomalía radical en el mundo antiguo. Trabajó con sus propias manos para mantenerse. Esta declaración al pueblo no es modestia retórica: Benjamín establece el principio de que la autoridad que sirve es la autoridad legítima. Y usa su propio servicio como argumento teológico: si yo que soy vuestro rey os sirvo, cuánto más debéis servir a Dios que os da todo.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Mosíah 2:17', text: 'Y he aquí, os digo estas cosas para que aprendáis sabiduría; para que aprendáis que cuando estáis al servicio de vuestros semejantes, estáis solamente al servicio de vuestro Dios.' },
            { type: 'paragraph', text: 'Este versículo — el más citado del discurso de Benjamín — conecta directamente el servicio humano con el servicio divino. No como metáfora ("es como si sirvieras a Dios") sino como declaración directa ("estáis al servicio de vuestro Dios"). El ser humano creado a imagen de Dios lleva en sí la presencia divina — atenderlo es atender a Dios. Este principio precede y prepara la revelación de Mateo 25:40.' },
            { type: 'reflection', prompt: '¿Qué cambiaría en la manera en que tratas a las personas de tu vida cotidiana — familia, compañeros de trabajo, desconocidos — si lo experimentaras literalmente como servicio a Dios?' },
          ],
        },
      ],
    },
