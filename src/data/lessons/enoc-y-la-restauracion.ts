  ...
  studySections: [
    {
      ...
      intro: { romanNumeral: 'V', heading: 'Solo la Restauración Tiene Este Texto', subheading: 'Por qué Moisés 6-7 importa más de lo que parece' },
      topics: [
        {
          id: 't5',
          ...
          blocks: [
            ...
            { type: 'highlight_verse', id: 'v1', reference: 'Moisés 7:62', text: 'Y la justicia enviaré desde el cielo; y la verdad la enviaré de la tierra para dar testimonio de mi Unigénito; su resurrección de entre los muertos; sí, y también la resurrección de todos los hombres; y la justicia y la verdad barreré la tierra como con un diluvio, para recoger a mis elegidos de los cuatro ángulos de la tierra.' },
            { type: 'doctrine_box', id: 'db1', title: 'El Proyecto de Enoc es el Proyecto de la Iglesia', content: 'Las tres marcas de Sión — un solo corazón, justicia, sin pobres — son los objetivos explícitos de la Iglesia restaurada. Las ofrendas de ayuno abordan la pobreza. Los convenios del templo forjan la unidad de corazón. La consagración es el principio económico de Sión. El proyecto que Enoc comenzó hace milenios es el mismo que la Iglesia de Jesucristo de los Santos de los Últimos Días busca completar en la dispensación final.' },
            { type: 'reflection', id: 'r1', prompt: '¿Qué tan cerca está tu barrio o rama de los tres criterios de Sión de Enoc: un corazón, justicia, sin pobres? ¿Cuál es el más difícil de alcanzar y por qué?' },
          ],
        },
      ],
    },
