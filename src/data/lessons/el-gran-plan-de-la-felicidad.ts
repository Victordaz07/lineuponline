...
export const elGranPlanDeLaFelicidad: Lesson = {
  id: 'el-gran-plan-de-la-felicidad',
  moduleId: 'temas-profundos',
  title: 'El Gran Plan de la Felicidad — Centrado en Cristo',
  subtitle: 'Tyler J. Griffin y Donald B. Anderson · Religious Educator, Vol. 18, 2017',
  description:
    'Los diagramas de círculos y flechas muestran a dónde vamos, pero no en quién nos convertimos. Este análisis del artículo más influyente sobre el Plan de Salvación redefine el propósito del plan: no es un mapa geográfico sino un proceso de transformación, con Cristo presente en cada estado de la existencia humana.',
  level: 'INTERMEDIO',
  icon: '🗺️',
  duration: 70,
  author: 'Tyler J. Griffin y Donald B. Anderson (BYU Religious Education)',
  order: 4,
  status: 'PUBLISHED',
  studyBodyPlain: '',
  originalBodyPlain: '',
  studySections: [
    {
      id: 'seccion-1',
      title: 'I. El problema que nadie nombra',
      intro: { romanNumeral: 'I', title: 'El problema que nadie nombra' },
      topics: [
        {
          id: 'el-mapa-y-el-territorio',
          ...
          blocks: [
            ...
            },
            {
              ...
              text: 'El hombre natural es enemigo de Dios, y lo ha sido desde la caída de Adán, y lo será para siempre jamás, a menos que se someta a los impulsos del Espíritu Santo.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'exaltacion-convertirse',
          title: 'Exaltación significa convertirse en alguien diferente',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'highlight_verse',
              reference: 'Mormón 9:4',
              text: 'He aquí, os digo que preferiríais sentir que las montañas os cayeran encima antes que estar en presencia de Dios sabiendo que no estáis limpios ante él.',
            },
            {
              type: 'deep_dive',
            ...
            {
              type: 'compare_grid',
              title: 'Dos maneras de entender el Plan',
              left: {
                label: 'Plan como mapa',
                points: [
                  'La meta es llegar al reino correcto',
                  'El éxito = cumplir los requisitos de entrada',
                  'El Evangelio es un conjunto de reglas a seguir',
                  'La fe es un boleto de acceso',
                  'El arrepentimiento borra infracciones',
                ],
              },
              right: {
                label: 'Plan como transformación',
                points: [
                  'La meta es convertirse en el tipo correcto de ser',
                  'El éxito = desarrollar el carácter de Dios',
                  'El Evangelio es un proceso de desarrollo eterno',
                  'La fe es la fuerza motriz de la transformación',
                  'El arrepentimiento cambia quién eres',
                ],
              },
            },
            {
    ...
    {
      id: 'seccion-2',
      title: 'II. Los tres pilares que lo sostienen todo',
      intro: { romanNumeral: 'II', title: 'Los tres pilares que lo sostienen todo' },
      topics: [
        {
          id: 'creacion-caida-expiacion',
          title: 'Creación, Caída, Expiación — una trilogía inseparable',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              ...
              text: 'Adán cayó para que los hombres fuesen; y los hombres son para que puedan tener gozo.',
            },
            {
              type: 'steps',
            ...
            {
              type: 'highlight_verse',
              reference: '2 Nefi 2:6-7',
              text: 'La redención viene en y por medio del Santo Mesías, porque él está lleno de gracia y de verdad. He aquí, él se ofrece a sí mismo en sacrificio por el pecado, para responder a los fines de la ley.',
            },
          ],
        },
        {
          id: 'sin-la-caida-imposible',
          title: 'Sin la Caída, la exaltación es imposible',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              ...
              text: 'Y si Adán no hubiera transgredido, no habría caído; sino que habría permanecido en el jardín del Edén. Y todas las cosas que fueron creadas hubieran permanecido en el mismo estado en que estaban después de ser creadas; y no hubieran tenido fin. Y no habrían tenido hijos.',
            },
            {
              type: 'doctrine_box',
    ...
    {
      id: 'seccion-3',
      title: 'III. Los seis estados del ser humano',
      intro: { romanNumeral: 'III', title: 'Los seis estados del ser humano' },
      topics: [
        {
          id: 'estados-uno-dos',
          title: 'Del estado premortal al estado de inocencia',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'key_points',
              title: 'Estado 1: Premortal (Hijos espirituales de Dios)',
              points: [
                'Éramos espíritus con inteligencia, personalidad y potencial, pero sin cuerpo físico',
                'Aceptamos el plan de salvación y el rol de Cristo como Salvador',
                'Ganamos experiencia, pero no podíamos avanzar sin la mortalidad',
                'Cristo fue "el Cordero inmolado desde la fundación del mundo" (Ap 13:8) — ya entonces',
                'Lo que nos faltaba: cuerpo físico, experiencia mortal, conocimiento del bien y del mal',
              ],
            },
            {
              type: 'key_points',
              title: 'Estado 2: Inocencia (Adán y Eva en el Edén)',
              points: [
                'Cuerpos físicos, pero sin experiencia del bien y del mal',
                'Separados de la presencia de Dios por el velo, aunque vivían en el Edén',
                'Sin la capacidad de tener hijos ni morir — atrapados en el estado inicial',
                'Cristo estaba presente: dio mandamientos a Adán y advirtió sobre la muerte',
                'Lo que les faltaba: la experiencia de la mortalidad y la necesidad de la Expiación',
              ],
            },
            {
              type: 'highlight_verse',
              reference: 'Génesis 3:15 / Moisés 4:21',
              text: 'Enemistad pondré entre ti y la mujer, y entre tu descendencia y la de ella; ésta te herirá en la cabeza, y tú la herirás en el calcañar.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'estados-tres-cuatro',
          title: 'El estado caído y el estado de redención — aquí es donde estamos',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'highlight_verse',
              reference: '2 Nefi 2:4',
              text: 'Y el camino está preparado desde la caída del hombre, y la salvación es libre.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'estados-cinco-seis',
          title: 'El mundo de los espíritus y el estado final',
          blocks: [
            {
              type: 'key_points',
              title: 'Estado 5: El mundo de los espíritus',
              points: [
                'Después de la muerte, el espíritu y el cuerpo se separan temporalmente',
                'La misión continúa: D&C 138 — Cristo organizó la prédica del Evangelio a los muertos',
                'El trabajo vicario del templo opera para este estado: las ordenanzas siguen disponibles',
                'No es un estado de inactividad — es un estado de preparación continua',
              ],
            },
            {
              type: 'key_points',
              title: 'Estado 6: El estado final — resurrección y juicio',
              points: [
                'Resurrección universal: todos reciben un cuerpo glorificado (el don incondicional)',
                'Juicio: cada persona recibe según el tipo de ser en que se convirtió',
                'Tres grados de gloria: celestial, terrestre, telestial — tres tipos de ser',
                'La misericordia y la justicia trabajan juntas: nadie recibe menos de lo que merece',
                'La presencia de Dios es celestial — no geográfica sino ontológica',
              ],
            },
            {
              type: 'highlight_verse',
    ...
    {
      id: 'seccion-4',
      title: 'IV. Redención universal vs. salvación condicional',
      intro: { romanNumeral: 'IV', title: 'Redención universal vs. salvación condicional' },
      topics: [
        {
          id: 'redencion-universal',
          title: 'Lo que Cristo hizo por TODOS sin condición',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              ...
              text: 'Así como en Adán todos mueren, así también en Cristo todos serán vivificados.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'salvacion-condicional',
          title: 'Lo que Cristo ofrece SI cooperas — la salvación del pecado personal',
          blocks: [
            {
              type: 'doctrine_box',
            ...
            {
              type: 'highlight_verse',
              reference: '2 Nefi 25:23',
              text: 'Pues sabemos que es por la gracia que nos salvamos, después de hacer todo lo que podemos.',
            },
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'compare_grid',
              title: 'Las dos dimensiones de la Expiación',
              left: {
                label: 'Redención incondicional',
                points: [
                  'De la muerte física (Caída de Adán)',
                  'Para TODOS los seres humanos',
                  'Sin condiciones, sin arrepentimiento necesario',
                  'Resultado: resurrección universal',
                  'Ya asegurada — cumplida en el Calvario',
                ],
              },
              right: {
                label: 'Salvación condicional',
                points: [
                  'Del pecado personal (nuestras transgresiones)',
                  'Para los que aceptan los términos del Evangelio',
                  'Requiere fe, arrepentimiento, convenios, fidelidad',
                  'Resultado: exaltación o grado de gloria según fidelidad',
                  'Disponible — requiere cooperación activa',
                ],
              },
            },
          ],
        ...
        {
          id: 'distincion-importancia',
          title: 'Por qué esta distinción cambia todo',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              type: 'highlight_verse',
              reference: 'D&C 88:32',
              text: 'Y los que queden también serán cambiados; no obstante, volverán a su propio lugar para gozar de lo que están dispuestos a recibir.',
            },
            {
              type: 'doctrine_box',
    ...
    {
      id: 'seccion-5',
      title: 'V. La oposición que vive adentro',
      intro: { romanNumeral: 'V', title: 'La oposición que vive adentro' },
      topics: [
        {
          id: 'naturaleza-caida-mecanismo',
          title: 'La naturaleza caída: el mecanismo de la prueba, no un castigo',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              type: 'highlight_verse',
              reference: 'Mosíah 3:19',
              text: 'El hombre natural es enemigo de Dios, y lo ha sido desde la caída de Adán, y lo será para siempre jamás, a menos que se someta a los impulsos del Espíritu Santo y se despoje del hombre natural y se convierta en santo por la expiación de Cristo el Señor.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'oposicion-diseno',
          title: 'Por qué la dificultad de la obediencia es el diseño, no el problema',
          blocks: [
            {
              type: 'highlight_verse',
              reference: '2 Nefi 2:11',
              text: 'Pues es necesario que haya oposición en todas las cosas. Si no fuera así, mi primogénito en el desierto... no habría existido ni el bien ni el mal, ni la santidad ni la miseria, ni el bien ni el mal.',
            },
            {
              type: 'compare_grid',
              title: 'Dos escenarios de mortalidad',
              left: {
                label: 'Sin oposición interna',
                points: [
                  'La obediencia sería fácil y costosa sin esfuerzo',
                  'No habría transformación real de carácter',
                  'El "bien" no tendría significado sin el contraste con el mal',
                  'La fe no tendría objeto — la certeza sería automática',
                  'El gozo profundo sería imposible sin el contraste con el dolor',
                ],
              },
              right: {
                label: 'Con oposición interna (diseño actual)',
                points: [
                  'Cada acto de obediencia es una victoria genuina',
                  'El carácter se forja en el crisol de decisiones reales',
                  'El bien es reconocido y valorado porque su ausencia se conoce',
                  'La fe se desarrolla eligiendo creer bajo presión contraria',
                  'El gozo de la obediencia es profundo porque costó algo real',
                ],
              },
            },
            {
    ...
    {
      id: 'seccion-6',
      title: 'VI. Cristo en cada estado del ser humano',
      intro: { romanNumeral: 'VI', title: 'Cristo en cada estado del ser humano' },
      topics: [
        {
          id: 'cristo-presente-cada-estado',
          title: 'Presente en los seis estados — el centro del modelo visual',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'highlight_verse',
              reference: 'Apocalipsis 13:8',
              text: 'El Cordero que fue inmolado desde la fundación del mundo.',
            },
            {
              type: 'steps',
        ...
        {
          id: 'implicacion-doctrinal',
          title: 'La implicación: no hay estado sin esperanza',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              type: 'highlight_verse',
              reference: 'D&C 88:6',
              text: 'El que ascendió sobre todas las cosas, a fin de que comprendiese todas las cosas, para que estuviese en todos y a través de todas las cosas.',
            },
            {
              type: 'doctrine_box',
    ...
    {
      id: 'seccion-7',
      title: 'VII. El juicio final — misericordia disfrazada',
      intro: { romanNumeral: 'VII', title: 'El juicio final — misericordia disfrazada' },
      topics: [
        {
          id: 'tres-reinos-justicia',
          title: 'Los tres reinos y la justicia perfecta',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            {
              type: 'highlight_verse',
              reference: 'D&C 76:89-90',
              text: 'Estos son los que quedarán: porque no recibieron la plenitud del evangelio de Jesucristo entre los vivos... No obstante, heredarán la salvación de Dios, no en el trono de la gloria de Dios, sino otro lugar diferente.',
            },
            {
              type: 'key_points',
              title: 'Los tres reinos como tres tipos de ser, no solo destinos',
              points: [
                'Reino Celestial: los que se convirtieron en seres celestiales a través de la Expiación y los convenios del Evangelio completo',
                'Reino Terrestre: los que vivieron honradamente pero rechazaron la plenitud del Evangelio o no persistieron en los convenios',
                'Reino Telestial: los que vivieron en transgresión pero eventualmente confesarán a Cristo — reciben un grado de gloria que excede todo entendimiento terrenal',
                'Hijos de perdición: los pocos que conocieron perfectamente la verdad y la rechazaron deliberadamente — el único resultado verdaderamente permanente sin gloria',
                'El reino que recibes corresponde al tipo de ser en que te convertiste, no a un veredicto arbitrario',
              ],
            },
          ],
        },
        {
          id: 'misericordia-reinos-inferiores',
          title: 'La misericordia de los reinos "inferiores"',
          blocks: [
            {
              type: 'highlight_verse',
              reference: 'Mormón 9:4',
            ...
            {
              type: 'compare_grid',
              title: 'Dos visiones del juicio final',
              left: {
                label: 'Juicio como punición',
                points: [
                  'Dios decide arbitrariamente quién va a dónde',
                  'Los reinos inferiores son cárceles de castigo',
                  'Gracia vs. obras en tensión irreconciliable',
                  'El perdón borra la consecuencia automáticamente',
                  'El juicio es externo al ser — se le impone',
                ],
              },
              right: {
                label: 'Juicio como revelación del ser',
                points: [
                  'El juicio revela el tipo de ser en que te convertiste',
                  'Los reinos inferiores son el máximo bien posible para ese ser',
                  'Gracia y obras cooperan en la transformación',
                  'El arrepentimiento genuino transforma el ser, no solo borra registros',
                  'El juicio es interno — eres exactamente lo que eres',
                ],
              },
            },
            {
    ...
    {
      id: 'seccion-8',
      title: 'VIII. El plan como motor de transformación',
      intro: { romanNumeral: 'VIII', title: 'El plan como motor de transformación' },
      topics: [
        {
          id: 'profetas-patrón-enseñanza',
          title: 'El patrón profético: explicar e invitar',
          blocks: [
            {
              type: 'paragraph',
              content:
            ...
            },
            {
              ...
              text: 'Y el Mesías viene en la plenitud de los tiempos para que pueda redimir a los hijos de los hombres de la caída. Y porque son redimidos de la caída, se han vuelto libres para siempre, conociendo el bien del mal; para obrar por sí mismos y no ser obrados por.',
            },
            {
              type: 'paragraph',
              content:
        ...
        {
          id: 'lo-que-el-plan-demanda',
          title: 'Lo que el plan demanda de ti',
          blocks: [
            {
              type: 'key_points',
              title: 'Las implicaciones prácticas del plan centrado en Cristo',
              points: [
                'El arrepentimiento no es solo evitar el castigo — es la herramienta principal de transformación',
                'Los convenios del Evangelio no son trámites religiosos — son los mecanismos de acceso a la gracia que transforma',
                'La fe en Cristo no es adhesión a una proposición abstracta — es confianza en que Su Expiación tiene poder para cambiarte',
                'El templo no es un edificio sagrado opcional — es donde se administran las ordenanzas del plan patriarcal de exaltación',
                'La mortalidad tiene duración limitada — la ventana de transformación tiene fin',
              ],
            },
            {
              type: 'highlight_verse',
              reference: '2 Nefi 9:27',
              text: '¡Ay de aquel que no escucha los mandamientos de Dios, pues el que los rechaza perece! ¡Y ay de aquel que desperdicia el día de su gracia, pues su estado será terrible!',
            },
            {
              type: 'doctrine_box',
        ...
        {
          id: 'vivir-el-plan',
          title: 'Vivir el plan, no solo conocerlo',
          blocks: [
            {
              type: 'paragraph',
              content:
