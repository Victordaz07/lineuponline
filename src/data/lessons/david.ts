      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: '1 Samuel 16:7', text: 'Y Jehová respondió a Samuel: No mires a su parecer, ni a lo grande de su estatura, porque yo lo desecho; porque Jehová no mira lo que mira el hombre; pues el hombre mira lo que está delante de sus ojos, pero Jehová mira el corazón.' },
            { type: 'paragraph', text: 'Cuando Samuel fue a ungir al próximo rey de Israel en la casa de Isaí, Dios rechazó a siete hijos antes de que llamaran al más joven, que estaba cuidando ovejas. David era el "pequeño" — literalmente el más joven. El principio establecido aquí es fundamental: Dios elige según criterios del corazón, no según apariencia, posición o experiencia. Este principio es consistente en toda la Escritura.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            ...
            { type: 'paragraph', text: 'David no argumentó sobre el tamaño de la honda o la precisión de su puntería. Su argumento era teológico: Goliat desafió al ejército de Dios, y Dios no puede perder. La confianza de David no era en su propia habilidad — era en la naturaleza de Dios. Esta distinción es la que hace que su historia no sea simplemente "un chico valiente" sino una lección sobre la naturaleza de la fe verdadera.' },
          ],
        },
      ],
    },
