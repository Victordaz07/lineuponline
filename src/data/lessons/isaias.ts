    ...
    },
    {
      ...
      topics: [
        ...
        },
        {
          ...
          blocks: [
            { type: 'key_points', title: 'Profecías cumplidas en Cristo', points: [
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Isaías 29:14', text: 'Por tanto, he aquí que nuevamente excitaré yo la admiración de este pueblo con un prodigio grande y espantoso; porque perecerá la sabiduría de sus sabios, y se desvanecerá la inteligencia de sus entendidos.' },
            { type: 'paragraph', text: 'Moroni citó Isaías 29:14 a José Smith en 1823 (JS-H 1:19) como una de las profecías a punto de cumplirse. Los versículos precedentes (29:11-12) describen "las palabras del libro sellado" que se dan al letrado y al iletrado — una descripción que encaja perfectamente con Martín Harris llevando la copia de los caracteres del Libro de Mormón al Prof. Anthon, y con la traducción de José Smith.' },
            { type: 'reflection', prompt: 'Si Isaías pudo ver con tal claridad eventos que ocurrirían 700 años después, ¿qué dice eso sobre la naturaleza de la revelación profética? ¿Qué pasajes de Isaías que has leído antes adquieren nuevo significado para ti ahora?' },
          ],
        },
      ],
    },
