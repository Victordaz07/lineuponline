      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Santiago 1:5 — que José Smith leyó y que le dijo que si carecía de sabiduría pidiera a Dios — no fue la génesis de un acto religioso casual. Fue la chispa que encendió una búsqueda real de un adolescente que había visto a su familia dividida por denominaciones en competencia, que escuchaba predicadores y no podía reconciliar sus contradicciones. La pregunta que llevó al bosque no fue teológica abstracta — fue: "¿Cuál de todas estas iglesias es verdadera?"' },
            { type: 'highlight_verse', reference: 'José Smith — Historia 1:17', text: 'Vi dos Personajes, cuyo brillo y gloria desafían toda descripción, quienes estaban de pie sobre mí en el aire. Uno de ellos me habló, llamándome por mi nombre, y dijo, señalando al otro: Este es mi Hijo Amado. ¡Escúchale!' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'DyC 1:38', text: 'Lo que yo el Señor he hablado, lo he hablado, y no me excuso; y aunque los cielos y la tierra pasen, mi palabra no pasará, sino que todos serán cumplidos, ya sea por mi propia voz o por la voz de mis siervos, es lo mismo.' },
            { type: 'paragraph', text: 'Entre 1831 y 1844, José Smith recibió más de 130 revelaciones registradas en DyC. Las doctrinas restauradas incluyen: la naturaleza corporal de Dios (1820), las tres glorias (1832), las ordenanzas del templo (1836-1844), el bautismo por los muertos (1840-41), el matrimonio celestial (1843), la preexistencia, la deificación, la organización del sacerdocio. Ninguna revelación de esta magnitud doctrinal había sido registrada desde la muerte de los apóstoles originales.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'José Smith fue asesinado en la cárcel de Carthage, Illinois, el 27 de junio de 1844. Tenía 38 años. Sus últimas palabras registradas fueron "¡Oh Señor, mi Dios!" — posiblemente el signo de socorro de la masonería que pensó sería respetado por la turba. DyC 135:3: "José Smith, el Profeta y Vidente del Señor, ha hecho más salvo Jesús, para la salvación de los hombres en este mundo, que cualquier otro hombre que jamás haya vivido en él." Esta es la afirmación más audaz de la Restauración — y la que requiere o creerla o rechazarla totalmente.' },
            { type: 'reflection', prompt: '¿Cuál es la revelación o doctrina de José Smith que más ha transformado tu comprensión de Dios y de tu relación con él? ¿Cuál encuentras más difícil de integrar y por qué?' },
          ],
        },
      ],
    },
