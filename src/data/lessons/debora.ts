      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Jueces 4:4-5 describe a Débora con tres títulos distintos: profetisa (neviá), mujer de Lapidot, y jueza de Israel. "Y ella juzgaba a Israel en aquel tiempo... y los hijos de Israel subían a ella a juicio." No hay narrativa de cómo llegó al cargo, sin justificación, sin debate. Simplemente era la jueza — y todo Israel la reconocía como tal. Ningún otro juez en el libro es descrito ejerciendo la justicia de manera tan directa y cotidiana.' },
            { type: 'doctrine_box', title: '"Madre en Israel"', body: 'En su cántico (Jueces 5:7), Débora se describe a sí misma como "madre en Israel." Este título no es diminutivo — es uno de los más altos de liderazgo en la cultura hebrea. Una "madre en Israel" era fundadora de familia, protectora de la comunidad, fuente de sabiduría y refugio para los vulnerables. Débora combinó autoridad judicial, don profético y maternidad espiritual de toda una nación.' },
          ],
        },
      ],
    },
