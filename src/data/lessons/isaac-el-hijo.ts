        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              rows: [
                { left: 'Nacido de Agar (sierva)', right: 'Nacido de Sara (libre)', label: 'Madre' },
                { left: 'Concebido según la carne — plan humano', right: 'Concebido por el poder de Dios', label: 'Origen' },
                { left: 'Prometido bendición y nación', right: 'Portador del convenio abrahámico', label: 'Llamamiento' },
                { left: 'Figura de la obra de la ley', right: 'Figura de la obra de la gracia', label: 'Símbolo (Gál 4)' },
              ],
            },
          ],
        },
