      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: '1 Nefi 3:7', text: 'Y aconteció que yo, Nefi, dije a mi padre: Iré y haré las cosas que el Señor ha mandado, porque sé que el Señor no da mandamientos a los hijos de los hombres a no ser que les prepare un camino para que puedan cumplir lo que les manda.' },
            { type: 'paragraph', text: 'Este versículo se pronunció antes de que Nefi supiera cómo obtener las planchas de bronce de Labán. Había fallado dos veces: el primer intento fue rechazado con palabras, el segundo con espadas. El principio que Nefi enuncia no es una garantía de éxito sin esfuerzo — es la convicción de que Dios provee caminos para los mandamientos que da. La tercera vez, fue "conducido por el Espíritu, sin saber de antemano las cosas que haría" (1 Nefi 4:6).' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Después de escuchar la visión del árbol de la vida de su padre, Nefi quiso ver y entender las mismas cosas. 1 Nefi 11:1: "Y aconteció que después que yo, Nefi, hubiera deseado esto en mi corazón, he aquí que fui arrebatado en el Espíritu del Señor, sí, a un monte muy alto." La condición para la visión fue desear comprenderla. El Espíritu preguntó primero: "¿Crees tú que tu padre vio el árbol del que habló?" La respuesta: "Sí, lo creo." El creer precedió al ver.' },
            { type: 'doctrine_box', title: 'La Expansión de la Visión', body: 'La visión de Nefi en 1 Nefi 11-14 toma la visión de su padre y la expande con explicación interpretativa: el árbol = el amor de Dios y María que da a luz al Hijo de Dios; la barra de hierro = la palabra de Cristo; el edificio = el orgullo del mundo; los ríos de agua sucia = la inmundicia del infierno. Nefi recibe no solo la visión sino la hermenéutica para interpretar cada símbolo.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: '2 Nefi 4:17,19', text: 'No obstante, en quién me gocé son las cosas del Señor; y no debo regocijarme en mi carne. Mi alma alaba a Dios; sí, y clamará a Dios mientras viva... Sin embargo, sé en quién he confiado.' },
            { type: 'paragraph', text: '2 Nefi 4:17-35, el "Salmo de Nefi," es el texto más íntimo del Libro de Mormón. Nefi — el mismo que mató a Labán, construyó un navío, vio a Cristo — lamenta sus propias debilidades: "¡Oh alma miserable! ¿Por qué cediste al pecado? ¿Por qué me enojé a causa de mi enemigo?" No hay indicación de qué pecado específico pesaba sobre él. Hay el testimonio de que la lucha espiritual no termina con la grandeza lograda.' },
          ],
        },
      ],
    },
