      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: '1 Nefi 1:6-7 describe la visión inaugural de Lehi: "Aconteció que mientras oraba al Señor, hubo una columna de fuego que habitó sobre una roca que estaba ante él... Y vio y oyó mucho." La reacción física fue casi idéntica a la de Juan en Apocalipsis o de Pablo en el camino a Damasco: Lehi se postró. Luego tuvo otra visión donde recibió un libro y lo leyó: la destrucción de Jerusalén. Salió a proclamarlo. El pueblo intentó matarlo.' },
            { type: 'highlight_verse', reference: '1 Nefi 2:4', text: 'Y aconteció que siendo obediente a la palabra del Señor, salió al desierto. Y dejó su casa y la tierra de su herencia, y su oro y su plata y sus cosas preciosas, y no llevó nada, excepto su familia y provisiones y tiendas, y se fue al desierto.' },
          ],
        },
      ],
    },
