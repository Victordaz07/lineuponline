...
export const sumoSacerdoteBienesVenideros: Lesson = {
  id: 'sumo-sacerdote-bienes-venideros',
  moduleId: 'discursos-sermones-clasicos',
  title: 'Sumo Sacerdote de los Bienes Venideros',
  subtitle: 'Jeffrey R. Holland · Conferencia General, octubre 1999',
  description:
    'Para los que esperan una bendición que no llega, para los que tienen miedo en los primeros kilómetros del camino, para los que aman a Dios pero no ven la salida: el Evangelio promete que las bendiciones siempre llegan. Algunas pronto, otras más tarde, y otras hasta el cielo — pero llegan.',
  level: 'BÁSICO',
  icon: '⚓',
  duration: 45,
  order: 7,
  ...
  studySections: [
    {
      id: 'seccion-1',
      title: 'I. Un título que lo cambia todo',
      intro: { romanNumeral: 'I', title: 'Un título que lo cambia todo' },
      topics: [
        {
          id: 'hebreos-titulo',
          title: 'El sumo sacerdote de lo que está por venir',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            },
            {
              ...
              reference: 'Hebreos 8:6',
              text: 'Mas ahora tanto mejor ministerio es el suyo, cuanto es mediador de un mejor pacto, establecido sobre mejores promesas.',
            },
            {
              type: 'paragraph',
              text:
            ...
            },
            {
              ...
              text: 'Y ¿qué es lo que debéis esperar? Os digo que debéis tener esperanza mediante la expiación de Cristo y el poder de su resurrección, para ser resucitados a la vida eterna; y esto, por vuestra fe en él según la promesa.',
            },
            {
              type: 'deep_dive',
        ...
        {
          id: 'la-promesa-central',
          title: 'La promesa central del discurso',
          blocks: [
            {
              type: 'leader_quote',
    ...
    {
      id: 'seccion-2',
      title: 'II. Para todos los que esperan',
      intro: { romanNumeral: 'II', title: 'Para todos los que esperan' },
      topics: [
        {
          id: 'a-quien-habla',
          title: 'Holland ve personas específicas, no audiencias genéricas',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'key_points',
              title: 'Las personas a quienes Holland dirige su mensaje',
              points: [
                'Misioneros recién llamados que enfrentan rechazo, añoranza del hogar y sienten que no pueden con el llamado',
                'Padres jóvenes estudiando mientras crían hijos con recursos limitados',
                'Padres solteros enfrentando la vida sin el apoyo de un cónyuge',
                'Los que desean casarse pero no han encontrado a esa persona',
                'Los que desean tener hijos pero no han podido',
                'Los que lloran la pérdida de seres amados',
                'Los que padecen enfermedades graves',
                'Los que luchan con el pecado y buscan redención',
              ],
            },
            {
              type: 'highlight_verse',
              reference: '3 Nefi 17:7',
              text: '¿Tenéis enfermos entre vosotros? Traédmelos. ¿Tenéis tullidos, o ciegos, o cojos, o mutilados, o leprosos, o que están marchitos, o que son sordos, o que son afligidos en cualquier manera? Traédmelos a mí.',
            },
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-3',
      title: 'III. Los primeros kilómetros son los más difíciles',
      intro: { romanNumeral: 'III', title: 'Los primeros kilómetros son los más difíciles' },
      topics: [
        {
          id: 'misioneros-inicio',
          title: 'Para los que están comenzando sin certezas',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            },
            {
              ...
              text: 'He aquí, yo soy Dios; habla con tu boca, y ella será llenada, y te daré a conocer lo que escribirás.',
            },
            {
              type: 'highlight_verse',
              reference: 'D&C 84:88',
              text: 'Y yo iré ante vuestro rostro. Estaré a vuestra diestra y a vuestra siniestra, y mi Espíritu estará en vuestro corazón, y mis ángeles en derredor de vosotros, para sustentaros.',
            },
            {
              type: 'doctrine_box',
        ...
        {
          id: 'portafolio-fe',
          title: 'Construyendo el portafolio de evidencias',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-4',
      title: 'IV. El Cristo que también esperó',
      intro: { romanNumeral: 'IV', title: 'El Cristo que también esperó' },
      topics: [
        {
          id: 'siervo-sufriente',
          title: 'Varón de dolores, experimentado en quebranto',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-5',
      title: 'V. La historia de los dos momentos',
      intro: { romanNumeral: 'V', title: 'La historia de los dos momentos' },
      topics: [
        {
          id: 'kanarraville-1969',
          title: 'Kanarraville, 1969: el radiador roto',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'dialogue',
              title: 'El momento en Kanarraville',
              lines: [
                {
        ...
        {
          id: 'kanarraville-1999',
          title: 'El mismo lugar, treinta años después',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-6',
      title: 'VI. La fe de Abraham — ver lo prometido antes de tenerlo',
      intro: { romanNumeral: 'VI', title: 'La fe de Abraham — ver lo prometido antes de tenerlo' },
      topics: [
        {
          id: 'fe-abrahan',
          title: 'El modelo bíblico de la espera fiel',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'compare_grid',
              title: 'La fe según el mundo vs. la fe según Hebreos 11',
              left: {
                label: 'Fe según el mundo',
                points: [
                  'Creer sin evidencia — actitud infantil',
                  'Una apuesta que puede perderse',
                  'Confianza que desaparece si no ves resultados',
                  'Una emoción que viene y va',
                  'Razonable solo si el riesgo es bajo',
                ],
              },
              right: {
                label: 'Fe según Hebreos 11',
                points: [
                  '"Certeza de lo que se espera" — presente real del futuro',
                  'La sustancia misma de las promesas de Dios',
                  'Confianza basada en el carácter de Dios, no en resultados visibles',
                  'Una disposición del ser que se mantiene bajo presión',
                  'La única respuesta racional ante un Dios que ha prometido',
                ],
              },
            },
            {
        ...
        {
          id: 'disciplina-espera',
          title: 'La disciplina espiritual de sostener promesas antes de recibirlas',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-7',
      title: 'VII. Cuando las bendiciones llegan al cielo',
      intro: { romanNumeral: 'VII', title: 'Cuando las bendiciones llegan al cielo' },
      topics: [
        {
          id: 'bendiciones-posmortalidad',
          title: 'La promesa que incluye la eternidad',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'highlight_verse',
              reference: 'D&C 58:2-4',
              text: 'Pues de cierto os digo que a todos los que guardan mis mandamientos les será dado, después de mucha tribulación, la bendición. He aquí, esto es fiel y verdadero. Vosotros que clamente en mis caminos, no murmuréis.',
            },
            {
              type: 'highlight_verse',
        ...
        {
          id: 'esperanza-activa',
          title: 'Esperanza activa, no resignación pasiva',
          blocks: [
            {
              type: 'compare_grid',
              title: 'Dos maneras de esperar',
              left: {
                label: 'Resignación',
                points: [
                  '"Supongo que nunca lo recibiré"',
                  'Detiene el crecimiento espiritual',
                  'Mira el presente con amargura',
                  'Desconecta de Dios por decepción',
                  'Trata la promesa como incumplida',
                ],
              },
              right: {
                label: 'Esperanza activa (fe en Hebreos 11)',
                points: [
                  '"Lo recibiré — en el tiempo y forma de Dios"',
                  'Energiza el crecimiento continuo',
                  'Mira el futuro con certeza',
                  'Profundiza la relación con Dios en la espera',
                  'Sostiene la promesa como ya garantizada',
                ],
              },
            },
            {
    ...
    {
      id: 'seccion-8',
      title: 'VIII. La promesa que no falla',
      intro: { romanNumeral: 'VIII', title: 'La promesa que no falla' },
      topics: [
        {
          id: 'siempre-llegan',
          title: 'Para los que aceptan el Evangelio, siempre llegan',
          blocks: [
            {
              type: 'paragraph',
              text:
        ...
        {
          id: 'reflexion-final',
          title: 'Sostén la promesa hasta que llegue',
          blocks: [
            {
              type: 'highlight_verse',
              reference: 'Moroni 7:40-42',
              text: 'Y además os digo que no puede haber fe y esperanza salvo que haya esperanza en algo. Si el hombre no tiene fe, no puede tener esperanza; y si no tiene esperanza, no puede tener caridad; y si no tiene caridad, no es nada.',
            },
            {
              type: 'paragraph',
              text:
