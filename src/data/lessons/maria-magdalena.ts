      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p2', text: 'Cuando Jesús fue arrestado, los doce discípulos varones huyeron (Marcos 14:50). Solo Juan regresó a la cruz. Las mujeres — María Magdalena, María madre de Jacobo, Salomé — permanecieron hasta el final (Marcos 15:40). Ellas observaron dónde fue sepultado. Fueron las primeras en ir al sepulcro el domingo por la mañana. La fidelidad de las mujeres durante la pasión contrasta marcadamente con la cobardía de los hombres.' },
            { type: 'highlight_verse', id: 'v1', reference: 'Juan 19:25', text: 'Pero estaban junto a la cruz de Jesús su madre, y la hermana de su madre, María mujer de Cleofas, y María Magdalena.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          title: '"María"',
          blocks: [
            { type: 'highlight_verse', id: 'v2', reference: 'Juan 20:15-16', text: 'Jesús le dijo: Mujer, ¿por qué lloras? ¿A quién buscas? Ella, pensando que era el hortelano, le dijo: Señor, si tú lo has llevado, dime dónde lo has puesto, y yo lo llevaré. Jesús le dijo: ¡María! Volviéndose ella, le dijo: ¡Raboni! (que quiere decir, Maestro).' },
            { type: 'paragraph', id: 'p3', text: 'El momento más tierno de los relatos de la resurrección: María no reconoce al Cristo resucitado hasta que él dice su nombre. Una sola palabra — "María" — pronunciada con la voz que la conocía. Este es el primero de todos los testimonios de la resurrección. Antes de Pedro, antes de los once, antes de Santiago: fue una mujer que había sido poseída por siete demonios quien dijo "He visto al Señor" (Juan 20:18).' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p4', text: 'En el siglo primero, el testimonio de una mujer no era admisible en un tribunal judío. Si los primeros cristianos hubieran inventado los relatos de la resurrección, no habrían elegido a una mujer como primer testigo — especialmente una con historia de posesión demoníaca. El hecho de que los cuatro Evangelios registren el descubrimiento de la tumba vacía por mujeres, con María Magdalena al frente, es precisamente lo que hace el relato históricamente creíble. Los falsificadores habrían elegido a Pedro.' },
            { type: 'reflection', id: 'r1', prompt: '¿Qué te dice sobre el carácter de Cristo el hecho de que eligiera aparecer primero a una mujer — y específicamente a una mujer que había tenido una historia de sufrimiento severo? ¿Qué dice eso sobre a quién busca Cristo primero?' },
          ],
        },
      ],
    },
