      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Cuando Brigham Young dirigió la reunión de agosto de 1844 sobre la sucesión del profeta, varios testigos presenciales registraron algo extraordinario: que mientras hablaba, su voz y porte se transformaron para parecerse a José Smith. Este evento no aparece en documentos contemporáneos de 1844 pero fue relatado por docenas de testigos décadas después. El manto del profeta cayó — en la percepción de los presentes — sobre Brigham, y la membresía lo reconoció como sucesor por amplia mayoría.' },
            { type: 'highlight_verse', reference: 'DyC 107:23', text: 'Los doce apóstoles viajantes constituyen un cuerpo igual en autoridad y poder al quórum de la Primera Presidencia.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'En 1846, Brigham Young lideró el éxodo de Nauvoo — 16,000 Santos expulsados por la violencia anti-mormona. En invierno cruzaron el río Mississippi y el río Missouri. El primer grupo llegó al Valle del Gran Lago Salado el 24 de julio de 1847. Brigham, enfermo de fiebre, levantó la vista desde el carruaje y dijo: "Este es el lugar correcto." En dos décadas, 70,000 personas habían hecho el recorrido de 1,300 millas. La logística fue extraordinaria.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Brigham Young gobernó Utah durante 30 años — como presidente de la Iglesia, gobernador territorial, y padre de una colonia. Fundó más de 350 ciudades y pueblos, estableció el sistema de irrigación que hizo fértil el desierto, fundó la Universidad de Utah y la Universidad Brigham Young, y comenzó la construcción del Templo de Salt Lake — cuya finalización no vería en vida (se completó 40 años después de comenzarse). Su legado es físico, institucional, y espiritual.' },
            { type: 'reflection', prompt: '¿Qué "desierto" estás siendo llamado a habitar y transformar — un matrimonio difícil, una comunidad desfavorecida, un campo de misión sin frutos visibles? ¿Cómo el ejemplo de Brigham — que tomó un territorio árido y construyó una civilización — te habla sobre la visión a largo plazo?' },
          ],
        },
      ],
    },
