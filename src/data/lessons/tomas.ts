      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'La tradición cristiana sostenida en India atribuye la evangelización del subcontinente a Tomás. La Iglesia de Santo Tomás en Kerala, India, se considera una de las más antiguas del mundo, fundada según la tradición en 52 d.C. El hombre que dijo "no creeré" murió por su fe — según la tradición, alanceado en Mylapore, India. La duda no fue el final de su historia. Fue el umbral.' },
            { type: 'reflection', prompt: '¿Hay preguntas o dudas sobre tu fe que no te has atrevido a expresar honestamente? ¿Qué te diría el ejemplo de Tomás — que Cristo vino específicamente a él con evidencia — sobre cómo Cristo responde a la duda honesta?' },
          ],
        },
      ],
    },
