...
export const sacerdocioPoderMujer: Lesson = {
  id: 'sacerdocio-poder-mujer',
  moduleId: 'sacerdocio',
  title: 'El Juramento y Convenio del Sacerdocio — También es de las Mujeres',
  subtitle: 'Barbara Morgan Gardner · Religious Educator, Vol. 22, 2021 · D&C 84',
  description:
    'El Presidente Nelson preguntó en 2019 si las mujeres entendían el poder del sacerdocio que les pertenece por convenio. La mayoría respondió que no. Este artículo académico — y esta lección — lo explica con precisión: las mujeres tienen poder sacerdotal real a través de sus convenios del templo, no simbólico ni de segunda categoría.',
  level: 'AVANZADO',
  icon: '👑',
  duration: 75,
  order: 11,
  status: 'PUBLISHED',
  author: 'Barbara Morgan Gardner (BYU Religious Education)',
  studyBodyPlain: '',
  originalBodyPlain: '',
  studySections: [
    {
      id: 'seccion-1',
      title: 'I. La pregunta del profeta que reveló una crisis',
      intro: { romanNumeral: 'I', title: 'La pregunta del profeta que reveló una crisis' },
      topics: [
        {
          id: 'nelson-pregunta-2019',
          title: 'Una pregunta que no esperaba esa respuesta',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-2',
      title: 'II. Dos estructuras de sacerdocio — cuál es la fundamental',
      intro: { romanNumeral: 'II', title: 'Dos estructuras de sacerdocio — cuál es la fundamental' },
      topics: [
        {
          id: 'orden-patriarcal',
          title: 'La orden patriarcal: Adán Y Eva juntos',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'compare_grid',
              title: 'Las dos estructuras del sacerdocio',
              left: {
                label: 'Orden Patriarcal',
                points: [
                  'Operó desde Adán hasta Moisés',
                  'Centrada en la familia, no en la institución',
                  'Tanto el hombre como la mujer entran juntos',
                  'Adán Y Eva recibieron promesas idénticas',
                  'Es la estructura eterna del reino celestial',
                  'Se administra en el templo',
                ],
              },
              right: {
                label: 'Estructura Administrativa',
                points: [
                  'Establecida más plenamente tras la mortalidad de Cristo',
                  'Centrada en la institución eclesiástica',
                  'Ordenación a oficios específicos (para varones)',
                  'Apóstoles, setentas, obispos, presidentes',
                  'Necesaria para la mortalidad — no necesariamente eterna',
                  'Se administra en la Iglesia',
                ],
              },
            },
            {
        ...
        {
          id: 'adan-eva-ambos',
          title: 'Adán Y Eva — ambos en el sacerdocio',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'key_points',
              title: 'Evidencia histórica de la participación femenina en el sacerdocio patriarcal',
              points: [
                'Adán Y Eva entraron juntos en la orden patriarcal (plenitud del sacerdocio de Melquisedec)',
                'Abraham Y Sara — ambos en la orden patriarcal, ambos con promesas eternas',
                'Noé y su esposa — la familia como unidad sacerdotal',
                'El patrón consistente: los patriarcas Y matriarcas, siempre juntos',
                'Joseph Smith dijo que quería que las mujeres fueran "un reino de sacerdotisas"',
              ],
            },
            {
              type: 'reflection',
    ...
    {
      id: 'seccion-3',
      title: 'III. Lo que la Gran Apostasía quitó y Elías devolvió',
      intro: { romanNumeral: 'III', title: 'Lo que la Gran Apostasía quitó y Elías devolvió' },
      topics: [
        {
          id: 'apostasia-restauracion',
          title: 'La restauración fue incompleta hasta 1836',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            },
            {
              ...
              reference: 'D&C 110:13-16',
              text: 'He aquí, han llegado el tiempo prometido, y el día anhelado de Elías el profeta para volverse, antes que llegue el gran y terrible día del Señor... Por tanto, las llaves de esta dispensación están en vuestras manos.',
            },
            {
              type: 'paragraph',
              text:
        ...
        {
          id: 'nauvoo-1842',
          title: 'Nauvoo 1842: la restauración del sacerdocio para las mujeres',
          blocks: [
            {
              type: 'paragraph',
              text:
              ...
              steps: [
                {
                  ...
                  body: 'Joseph Smith organizó la Sociedad de Socorro como "contraparte y compañera de los quórums del sacerdocio masculino" — no un club de servicio, sino la organización sacerdotal femenina de la Iglesia.',
                },
                {
                  step: 'Mayo 4, 1842',
                  title: 'Primeros endowments — solo para hombres',
                  body: 'Nueve hombres recibieron el endowment en la tienda de Joseph. "La primera vez en estos últimos días" que las ordenanzas del templo fueron restauradas.',
                },
                {
                  step: 'Septiembre 1843',
                  title: 'Las mujeres reciben el endowment',
                  body: 'Las mujeres de la Sociedad de Socorro recibieron sus endowments, convirtiéndose en "participantes plenas tanto en recibir como en realizar ordenanzas del sacerdocio." Bathsheba W. Smith recordó que Joseph quería hacer de ellas "un reino de sacerdotisas."',
                },
              ],
            },
            {
    ...
    {
      id: 'seccion-4',
      title: 'IV. D&C 84:33-42 — el juramento y convenio también es de las mujeres',
      intro: { romanNumeral: 'IV', title: 'D&C 84:33-42 — el juramento y convenio también es de las mujeres' },
      topics: [
        {
          id: 'versos-33-42',
          title: 'Las promesas que incluyen a las mujeres',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'highlight_verse',
              reference: 'D&C 84:33-34',
              text: 'Pues quien recibe mis siervos recibe a mí; y quien me recibe a mí recibe a mi Padre; y el que recibe a mi Padre recibe el reino de mi Padre; por tanto, todas las que mi Padre tiene se les darán.',
            },
            {
              type: 'highlight_verse',
              reference: 'D&C 84:38',
              text: 'Y aquel que reciba la plenitud de mi evangelio... tendrá el derecho a todas las cosas que yo tengo.',
            },
            {
              type: 'leader_quote',
        ...
        {
          id: 'que-significa-para-mujeres',
          title: 'Qué significa "obtener el sacerdocio" para una mujer',
          blocks: [
            {
              type: 'paragraph',
              text:
    ...
    {
      id: 'seccion-5',
      title: 'V. La llave del conocimiento de Dios — también para las mujeres',
      intro: { romanNumeral: 'V', title: 'La llave del conocimiento de Dios — también para las mujeres' },
      topics: [
        {
          id: 'llave-conocimiento',
          title: 'D&C 84:19 — una llave para todos los que guardan convenios',
          blocks: [
            {
              type: 'highlight_verse',
              reference: 'D&C 84:19-20',
              text: 'Y este mayor sacerdocio administra el evangelio y tiene la llave de los misterios del reino, incluso la llave del conocimiento de Dios. Por tanto, en las ordenanzas de este sacerdocio se manifiesta el poder de la divinidad.',
            },
            {
              type: 'paragraph',
              text:
        ...
        {
          id: 'ministerio-de-angeles',
          title: 'El derecho a la ministración de ángeles',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            },
            {
              type: 'highlight_verse',
              reference: 'D&C 13:1',
              text: 'Sobre vosotros, mis consiervos, en nombre de Mesías confiero el sacerdocio de Aarón, que tiene las llaves del ministerio de ángeles, y del evangelio del arrepentimiento.',
            },
            {
              type: 'doctrine_box',
    ...
    {
      id: 'seccion-6',
      title: 'VI. Autoridad sacerdotal en los llamamientos',
      intro: { romanNumeral: 'VI', title: 'Autoridad sacerdotal en los llamamientos' },
      topics: [
        {
          id: 'autoridad-llamamientos',
          title: 'Cuando una mujer es apartada, recibe autoridad sacerdotal',
          blocks: [
            {
              type: 'leader_quote',
              name: 'Dallin H. Oaks',
        ...
        {
          id: 'cambio-manual',
          title: 'El Manual General 2020 — un cambio lingüístico significativo',
          blocks: [
            {
              type: 'compare_grid',
              title: 'Evolución de la definición de sacerdocio',
              left: {
                label: 'Manual 2010',
                points: [
                  '"La autoridad que Dios da al hombre..."',
                  'Sacerdocio = autoridad masculina',
                  'Las mujeres: beneficiarias indirectas',
                  'Lenguaje exclusivo de género en la definición',
                ],
              },
              right: {
                label: 'Manual General 2020',
                points: [
                  '"La autoridad y el poder que Dios otorga a Sus hijos e hijas sobre la tierra..."',
                  'Sacerdocio = autoridad y poder para ambos',
                  'Las mujeres: participantes directas',
                  'Lenguaje inclusivo — reconoce la realidad doctrinal',
                ],
              },
            },
            {
    ...
    {
      id: 'seccion-7',
      title: 'VII. Para las que están sin compañero del sacerdocio en casa',
      intro: { romanNumeral: 'VII', title: 'Para las que están sin compañero del sacerdocio en casa' },
      topics: [
        {
          id: 'mujeres-solas',
          title: 'La promesa directa del Presidente Nelson',
          blocks: [
            {
              type: 'paragraph',
              text:
        ...
        {
          id: 'todas-las-cosas',
          title: '"Todas las cosas que yo tengo" — sin excepciones',
          blocks: [
            {
              type: 'paragraph',
              text:
            ...
            {
              type: 'key_points',
              title: 'La promesa del sacerdocio para las mujeres — sin condición de estado civil',
              points: [
                'La mujer soltera que guardó sus convenios: "todas las cosas que yo tengo"',
                'La mujer divorciada que fue fiel: "todas las cosas que yo tengo"',
                'La madre sin compañero del sacerdocio en casa: "todas las cosas que yo tengo"',
                'La mujer en familia parcialmente miembro: "todas las cosas que yo tengo"',
                'La condición es el convenio, no el estado civil ni la presencia de un varón',
              ],
            },
            {
              type: 'reflection',
    ...
    {
      id: 'seccion-8',
      title: 'VIII. Vivir con el poder del sacerdocio',
      intro: { romanNumeral: 'VIII', title: 'Vivir con el poder del sacerdocio' },
      topics: [
        {
          id: 'implicaciones-practicas',
          title: 'Lo que cambia cuando lo sabes',
          blocks: [
            {
              type: 'paragraph',
              text:
              ...
              steps: [
                {
                  step: '1',
                  title: 'En el templo',
                  body: 'Participar en el trabajo del templo no es solo servicio caritativo. Es el ejercicio directo de la autoridad del sacerdocio para llevar a cabo ordenanzas salvadoras para los muertos. Cada mujer que trabaja en el templo está usando autoridad sacerdotal real.',
                },
                {
                  step: '2',
                  title: 'En el hogar',
                  body: 'Una mujer puede invocar el poder del sacerdocio en su hogar a través de sus convenios — en la oración, en la enseñanza de sus hijos, en la crianza guiada por el Espíritu. No necesita un varón presente para invocar ese poder; lo posee directamente.',
                },
                {
                  step: '3',
                  title: 'En los llamamientos',
                  body: 'Cuando una mujer es apartada en su llamamiento, recibe autoridad del sacerdocio para ejercer esa función. Reconocer eso cambia cómo se acerca a su llamamiento — no como voluntaria entusiasta, sino como persona con autoridad divina.',
                },
                {
                  step: '4',
                  title: 'En la vida diaria',
                  body: 'La "llave del conocimiento de Dios" (D&C 84:19) que viene con el endowment significa acceso a revelación personal, guía divina y poder para las responsabilidades que Dios ha asignado. Esto es diario y práctico, no ocasional y ceremonial.',
                },
              ],
            },
          ],
        ...
        {
          id: 'conclusion-nelson',
          title: 'La invitación que cierra el círculo',
          blocks: [
            {
              type: 'leader_quote',
              name: 'Russell M. Nelson',
