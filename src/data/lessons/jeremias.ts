      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v1', reference: 'Jeremías 1:5', text: 'Antes que te formase en el vientre te conocí, y antes que nacieses te santifiqué, te di por profeta a las naciones.' },
            { type: 'paragraph', id: 'p1', text: 'Este versículo es la declaración más clara de la preexistencia en el Antiguo Testamento canónico. "Te conocí" en hebreo (yadaati) implica conocimiento íntimo y personal, no solo conocimiento de posibilidad. Jeremías fue conocido, santificado y designado profeta ANTES de nacer. La Restauración enseña que esto es universal — cada persona fue conocida por Dios antes de nacer — pero Jeremías es la demostración bíblica más explícita.' },
            { type: 'paragraph', id: 'p2', text: 'La respuesta de Jeremías al llamamiento fue idéntica a la de Moisés: "¡Ah! ¡Señor Jehová! He aquí, no sé hablar, porque soy niño." Dios respondió exactamente igual: "No digas soy un niño; porque a todo lo que te envíe irás tú, y dirás todo lo que te mande." El patrón del llamamiento profético es consistente: inseguridad, comisión divina directa, promesa de asistencia.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v3', reference: 'Lamentaciones 3:22-23', text: 'Por la misericordia de Jehová no hemos sido consumidos, porque nunca decayeron sus misericordias. Nuevas son cada mañana; grande es tu fidelidad.' },
            { type: 'paragraph', id: 'p5', text: 'Lamentaciones 3:22-23 es uno de los textos más citados de la Biblia para la esperanza. Lo sorprendente es el contexto: Jeremías lo escribió en medio de las ruinas de Jerusalén, rodeado de cadáveres, habiendo visto destruido todo lo que amaba. La esperanza bíblica no es ciega al dolor — nace en él. "Grande es tu fidelidad" no es un slogan de prosperidad sino la declaración de un hombre en las ruinas que aun así encuentra razones para confiar en Dios.' },
            { type: 'reflection', id: 'r1', prompt: '¿Ha habido en tu vida un período de "Lamentaciones" — donde sentiste que todo colapsó? ¿Qué encontraste en medio de ese período que, como Jeremías 3:22-23, fue inesperadamente esperanzador?' },
          ],
        },
      ],
    },
