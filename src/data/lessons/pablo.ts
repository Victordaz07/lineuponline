      ...
      topics: [
        {
          ...
          blocks: [
            ...
            { type: 'paragraph', id: 'p3', text: 'La eclesiología de Pablo es fundamental para entender por qué la Restauración era necesaria. La lista de 1 Corintios 12:28 — apóstoles, profetas, maestros — describe la estructura organizacional que Cristo estableció. Efesios 4:11-13 explica el propósito: "a fin de perfeccionar a los santos... hasta que todos lleguemos a la unidad de la fe." Cuando esta estructura desapareció, la unidad de la fe se fragmentó en miles de denominaciones.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v3', reference: '2 Corintios 11:24-27', text: 'De los judíos cinco veces he recibido cuarenta azotes menos uno. Tres veces he sido azotado con varas; una vez apedreado; tres veces he padecido naufragio; una noche y un día he estado como náufrago en alta mar; en caminos muchas veces; en peligros de ríos, peligros de ladrones... en trabajo y fatiga, en muchos desvelos, en hambre y sed, en muchos ayunos, en frío y en desnudez.' },
            { type: 'paragraph', id: 'p4', text: 'Este catálogo no es propaganda — es la vida real de un apóstol en el siglo primero. Pablo no predicó desde posición de seguridad. Su motivación no puede explicarse por beneficio personal. La "espina en la carne" (2 Corintios 12:7) — no identificada en el texto — fue su compañera constante, y Dios la permitió para que su fortaleza se perfeccionara en la debilidad.' },
            { type: 'reflection', id: 'r1', prompt: '¿Qué precio has pagado personalmente por tu fe? ¿Cómo cambia tu perspectiva ver que Pablo, el mayor teólogo del NT, pagó ese precio con su propio cuerpo durante décadas?' },
          ],
        },
      ],
    },
