      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p1', text: 'El escenario inicial de Rut es pura pérdida: Noemí enviudó en tierra extranjera con dos nueras moabitas. Cuando decidió regresar a Belén, les dijo que se fueran a casa de sus madres. Orfa, la otra nuera, lloró y se fue. Rut se negó. No había ninguna obligación legal o moral que la retuviera — el matrimonio con el hijo de Noemí había terminado con la muerte del esposo. Rut eligió quedarse por amor y lealtad puros.' },
            { type: 'highlight_verse', id: 'v1', reference: 'Rut 1:16-17', text: 'Respondió Rut: No me ruegues que te deje, y me aparte de ti; porque a dondequiera que tú fueres, iré yo, y dondequiera que vivieres, viviré. Tu pueblo será mi pueblo, y tu Dios mi Dios. Donde tú murieres, moriré yo, y allí seré sepultada.' },
          ],
        },
      ],
    },
