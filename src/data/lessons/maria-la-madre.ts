      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p1', text: 'Gabriel se apareció a María con el anuncio que cambiaría el mundo. Lucas 1:29 dice que "se turbó" y discurrió qué tipo de salutación era esa — reacción completamente humana. Su primera pregunta fue práctica: "¿Cómo será esto? pues no conozco varón." Cuando Gabriel explicó que el Espíritu Santo vendría sobre ella y el poder del Altísimo la cubriría, María dijo una de las palabras más grandes de la historia: "He aquí la sierva del Señor; hágase conmigo conforme a tu palabra."' },
            { type: 'highlight_verse', id: 'v1', reference: 'Lucas 1:38', text: 'Entonces María dijo: He aquí la sierva del Señor; hágase conmigo conforme a tu palabra. Y el ángel se fue de su presencia.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v2', reference: 'Lucas 1:46-49', text: 'Entonces María dijo: Engrandece mi alma al Señor; y mi espíritu se regocija en Dios mi Salvador. Porque ha mirado la bajeza de su sierva; pues he aquí, desde ahora me dirán bienaventurada todas las generaciones. Porque me ha hecho grandes cosas el Poderoso; y Santo es su nombre.' },
            { type: 'paragraph', id: 'p2', text: 'El Magnificat de María (Lucas 1:46-55) es teología pura en forma poética. Una adolescente de Nazaret, sin educación rabínica, pronuncia un poema que integra a Elías, Ana (1 Samuel 2), los Salmos, y los Profetas. Su comprensión del carácter de Dios — que exalta a los humildes y derriba a los poderosos, que llena de bienes a los hambrientos — refleja una formación espiritual profunda. Los espirituales latinos lo han cantado diariamente por 1,500 años.' },
          ],
        },
      ],
    },
