      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'DyC 132:65 menciona a Sara en el contexto del matrimonio celestial: las esposas de Abraham "fueron dadas a él de Dios y a él pertenecían bajo la ley del sacerdocio." Sara no fue simplemente la esposa de Abraham — fue participante del convenio eterno que forjó la línea de Israel. La restauración eleva su papel de sujeto pasivo de la promesa a participante activa del convenio eterno.' },
            { type: 'reflection', prompt: '¿En qué ámbito de tu vida estás esperando un cumplimiento prometido que parece imposible dado donde estás ahora? ¿Cómo cambia el ejemplo de Sara — noventa años de espera, una risa de incredulidad, y aun así recibió — tu perspectiva sobre esa espera?' },
          ],
        },
      ],
    },
