      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v1', reference: 'Mormón 8:3,5', text: 'Mi padre fue muerto en batalla, y todos mis familiares, y no he tenido amigos ni adonde ir; y cuánto tiempo viviré no lo sé... Y no sé cuándo escribiré más; pero tengo pocas cosas que escribir acerca de mi pueblo.' },
            { type: 'paragraph', id: 'p1', text: 'Moroni escribió Mormón 8 creyendo que sería su última entrada. Su padre había muerto en la batalla final de Cumorah junto a 230,000 nefitas. Moroni era el sobreviviente solitario de una civilización. Sin familia, sin comunidad, sin destino conocido, escribe para una audiencia que no conocerá: los que lean el registro "en los postreros días." Escribe sabiendo que sus palabras traspasarán los siglos.' },
          ],
        },
      ],
    },
