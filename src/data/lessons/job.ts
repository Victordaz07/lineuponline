      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p2', text: 'Elifaz, Bildad y Zofar ofrecieron variaciones del mismo argumento: los justos prosperan, los impíos sufren; Job sufre, por tanto Job pecó. Esta teología de la retribución proporcional suena razonable y está basada en partes del Antiguo Testamento (como Deuteronomio 28). El problema es que es incompleta — no da cuenta del sufrimiento de los inocentes. Dios, al final, dice explícitamente que los amigos "no hablaron de mí lo recto" (Job 42:7).' },
            { type: 'key_points', id: 'kp1', title: 'Los errores de los amigos de Job', points: [
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v2', reference: 'Job 19:25-27', text: 'Yo sé que mi Redentor vive, y al fin se levantará sobre el polvo; y después de deshecha esta mi piel, en mi carne he de ver a Dios; al cual veré por mí mismo, y mis ojos lo verán, y no otro, aunque mi corazón desfallece dentro de mí.' },
            { type: 'paragraph', id: 'p3', text: 'Job pronunció estas palabras en el momento más bajo de su vida — enfermo, en cenizas, sin hijos, sin dinero, rodeado de amigos que lo acusan. Y declara: "Yo sé que mi Redentor vive." No "espero" ni "creo que quizás" — "YO SÉ." Su conocimiento del Redentor no dependía de sus circunstancias. Es la declaración de fe más audaz del Antiguo Testamento — y la más hermosa.' },
          ],
        },
      ],
    },
