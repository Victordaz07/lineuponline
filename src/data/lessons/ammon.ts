      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v2', reference: 'Alma 26:11-12', text: 'Pero Ammón respondió: No me glorío en mi propia fortaleza, ni en mi propia sabiduría; mas he aquí, mi gozo es pleno, sí, mi corazón rebosa de gozo, y me regocijaré en mi Dios. Sí, sé que no soy nada; en cuanto a mi fortaleza yo soy débil; por tanto no me gloriaré en mí mismo, sino que me gloriaré en mi Dios.' },
            { type: 'paragraph', id: 'p4', text: 'Cuando Ammón expresó su gozo, su hermano Aarón lo reprendió: "Temo que tu gozo te lleve a la jactancia." Ammón respondió con una de las declaraciones más claras del Libro de Mormón sobre la gracia y el ministerio: no se gloría en sí mismo sino en Dios. Todo lo que logró fue por el poder de Cristo que obraba a través de él. El gozo no era orgullo — era gratitud desbordante por haber sido instrumento en manos de Dios.' },
            { type: 'reflection', id: 'r1', prompt: '¿Hay alguien en tu vida — un "lamanita," alguien que consideras improbable para el evangelio, quizás incluso un enemigo histórico o cultural — a quien Dios te podría estar llamando a servir en lugar de predicarle directamente? ¿Cómo cambiaría tu enfoque?' },
          ],
        },
      ],
    },
