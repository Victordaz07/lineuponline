      ...
      topics: [
        {
          ...
          blocks: [
            ...
            { type: 'highlight_verse', id: 'v1', reference: 'Hechos 7:22', text: 'Y fue enseñado Moisés en toda la sabiduría de los egipcios, y era poderoso en sus palabras y obras.' },
            { type: 'paragraph', id: 'p2', text: 'La providencia es clara: Dios usó el sistema de opresión de Egipto para criar al propio libertador de Israel dentro de ese sistema. El perseguidor involuntariamente entrenó a su adversario. Este patrón se repite en José de Egipto, en Esther en la corte persa, en Daniel en Babilonia — Dios coloca a Sus siervos en el corazón del poder enemigo.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'compare_grid', id: 'cg1', title: 'La Paradoja de Éxodo 33', rows: [
            ...
            { type: 'paragraph', id: 'p5', text: 'La aparente contradicción se resuelve entendiendo que "cara a cara" describe la calidad de la comunicación — directa, personal, sin intermediario — mientras que la restricción de ver el "rostro" se refiere a la gloria plena del cuerpo glorificado. Moisés vio y habló con el Cristo premortal en forma de ángel/mensajero (como en Génesis 18); lo que no pudo ver fue la gloria completa del Padre. DyC 84:22-24 añade que Israel también perdió este privilegio por su incredulidad en el desierto.' },
            { type: 'reflection', id: 'r1', prompt: 'Moisés dedicó su vida a servir a un pueblo que constantemente se quejaba, rebelaba y defraudaba. ¿Qué fuente de fortaleza encuentras en esta historia para cuando el servicio a los demás se vuelve agotador y poco valorado?' },
          ],
        },
      ],
    },
