      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'En Kirtland, Ohio, el 3 de abril de 1836, después de la dedicación del templo, Moisés apareció a José Smith y Oliver Cowdery y les entregó las llaves de la reunión de Israel. Luego Elías apareció. Luego Elías el profeta. Cada aparición tenía que ver directamente con el convenio de Jacob/Israel — la promesa de que sus descendientes serían reunidos de los cuatro ángulos de la tierra.' },
            { type: 'highlight_verse', reference: 'DyC 110:11', text: 'Después de esta visión, se nos presentó Moisés y entregó las llaves de la congregación de Israel desde los cuatro ángulos de la tierra y de la guía de las diez tribus del país del norte.' },
            { type: 'key_points', title: 'Israel en la Restauración', points: [
            ...
            { type: 'reflection', prompt: '¿Cuál es tu tribu de Israel según tu bendición patriarcal? ¿Qué significa para ti ser literalmente descendiente (por nacimiento o adopción) del hombre que luchó con Dios y ganó su nombre?' },
          ],
        },
      ],
    },
