      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'DyC 135:6', text: 'Jamás cayó sangre del suelo de los EE.UU. que clamara más fuerte al cielo en testimonio contra aquel que la derramó que la sangre de Joseph y Hyrum Smith. Su muerte fue el mayor asesinato que jamás se cometió en América, y tendrá que rendir cuentas de él en el gran Día del Señor.' },
            { type: 'paragraph', text: 'John Taylor, que presenció el martirio (y sobrevivió con cuatro balas), escribió DyC 135. La afirmación es directa y solemne: la muerte de los hermanos Smith fue martirismo genuino — un testimonio sellado con sangre. El texto dice: "Vivieron por su obra, y sus nombres jamás serán olvidados." Para los creyentes que los siguieron, no son figuras de la historia — son testigos cuyo testimonio está sellado de manera irrevocable.' },
            { type: 'reflection', prompt: '¿Qué aspecto del carácter de Hyrum — la fidelidad que no abandona aunque cueste la vida — reconoces o desearías cultivar en tus relaciones más cercanas?' },
          ],
        },
      ],
    },
