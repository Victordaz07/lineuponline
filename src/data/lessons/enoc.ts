      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', id: 'p1', text: 'Cuando Dios llamó a Enoc, la respuesta del joven fue de completa inseguridad: "¿Por qué tu siervo ha hallado gracia ante tus ojos, siendo tan solo un muchacho, y todos me aborrecen, pues soy tardo en el habla?" (Moisés 6:31). El patrón se repite con Moisés, Jeremías, Pablo — Dios llama a quienes se sienten insuficientes, no a quienes se sienten capaces.' },
            { type: 'highlight_verse', id: 'v1', reference: 'Moisés 6:34', text: 'Y el Señor dijo a Enoc: Abre tu boca y ella será llenada, y te daré elocuencia, porque todas las carnes están en mis manos, y haré lo que sea mi voluntad.' },
            { type: 'paragraph', id: 'p2', text: 'La promesa es directa: no "te haré más listo" sino "abre la boca y la llenaré". El poder de Enoc no vino de su preparación personal sino de su disposición a hablar cuando Dios lo pedía. Esa es la diferencia entre el orador natural y el profeta.' },
          ],
        },
      ],
    },
