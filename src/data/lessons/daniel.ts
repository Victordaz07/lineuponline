      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v2', reference: 'Daniel 2:44', text: 'Y en los días de estos reyes el Dios del cielo levantará un reino que no será jamás destruido, ni será el reino dejado a otro pueblo; desmenuzará y consumirá a todos estos reinos, pero él permanecerá para siempre.' },
            { type: 'paragraph', id: 'p2', text: 'La estatua de Daniel 2 representa cuatro imperios mundiales: Babilonia (oro), Medo-Persia (plata), Grecia (bronce), Roma (hierro). La piedra cortada sin manos que destruye la estatua y llena toda la tierra es — según la Restauración — la Iglesia de Jesucristo de los Santos de los Últimos Días. José Smith citó explícitamente Daniel 2 al describir el propósito de la Restauración. La piedra que comenzó pequeña en 1830 está destinada a llenar la tierra.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', id: 'v4', reference: 'Daniel 6:10', text: 'Cuando Daniel supo que el edicto había sido firmado, entró en su casa, y abiertas las ventanas de su cámara que daban hacia Jerusalén, se arrodillaba tres veces al día, y oraba y daba gracias delante de su Dios, como lo solía hacer antes.' },
            { type: 'paragraph', id: 'p4', text: 'El detalle crucial: "como lo solía hacer antes." Daniel no hizo una declaración heroica ni organizó una protesta pública. Simplemente continuó haciendo lo que siempre había hecho — orar tres veces al día mirando hacia Jerusalén. La fidelidad rutinaria frente a la persecución es más poderosa que el heroísmo dramático. El foso de los leones fue la consecuencia de negarse a interrumpir un hábito de oración.' },
            { type: 'reflection', id: 'r1', prompt: '¿Hay hábitos espirituales en tu vida — oración, estudio de escrituras, asistencia al templo — que mantienes incluso cuando el entorno los hace incómodos o inconvenientes? ¿Qué costo has pagado o pagarías por mantenerlos?' },
          ],
        },
      ],
    },
