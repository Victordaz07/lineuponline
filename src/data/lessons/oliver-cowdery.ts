      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'DyC 8:2-3', text: 'Sí, yo os lo diré en vuestra mente y en vuestro corazón, por el Espíritu Santo, que vendrá sobre vosotros y que morará en vuestro corazón... Ahora, he aquí, esta es la voz del Espíritu.' },
            ...
            { type: 'reflection', prompt: '¿Qué te enseña la historia de Oliver sobre los testimonios que se obtienen por experiencia directa y cómo resisten incluso períodos de alejamiento o desacuerdo? ¿Hay un testimonio tuyo que has recibido y que podría sostenerte en un período de duda o desacuerdo?' },
          ],
        },
      ],
    },
