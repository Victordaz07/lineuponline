      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: '1 Reyes 19:4', text: 'Y él se fue por el desierto un día de camino, y vino y se sentó debajo de un enebro; y deseando morirse, dijo: Basta ya, oh Jehová, quítame la vida, pues no soy yo mejor que mis padres.' },
            { type: 'paragraph', text: 'El día después de su mayor triunfo, Elías quería morir. La reina Jezabel lo amenazó y huyó. Este pasaje es uno de los más honestos de toda la Biblia sobre la psicología del profeta: el agotamiento emocional que sigue a la crisis espiritual intensa. La respuesta de Dios no fue un sermón — fue comida y descanso. "Levántate y come, porque largo camino te resta." El ángel le dio de comer dos veces antes de pedirle algo.' },
            { type: 'doctrine_box', title: 'La Voz Apacible y Delicada', body: '1 Reyes 19:11-12: Dios pasó. Vino un gran viento, un terremoto, y fuego — y Dios no estaba en ninguno de ellos. Después del fuego vino una "voz apacible y delicada" (en hebreo: qol demamah daqah — literalmente "la voz del silencio fino"). Elías, que acababa de ver el fuego del cielo, encontró a Dios en el susurro. Esta es la lección más profunda de su historia: los grandes milagros demuestran poder, pero Dios habla en el silencio.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Uno de los puntos más complicados de la doctrina de la Restauración: DyC 110 distingue entre "Elías" (un mensajero que restauró el evangelio de Abraham, posiblemente Noé/Gabriel) y "Elías" el profeta del Carmelo. La Restauración usa "Elías" también como un título de oficio — el que prepara el camino. En Mateo 17 (la Transfiguración), es el Elías histórico del Carmelo quien aparece junto a Moisés para confirmar la autoridad de Cristo.' },
            { type: 'highlight_verse', reference: 'DyC 110:13-16', text: 'Después de este, Elías apareció y dijo: He aquí, se ha cumplido el tiempo, según lo que fue dicho por boca de Malaquías, el cual testificó que él sería enviado antes que llegue el día grande y terrible del Señor... para volver el corazón de los padres a los hijos y el corazón de los hijos a los padres, no sea que toda la tierra sea herida con maldición.' },
            { type: 'paragraph', text: 'El 3 de abril de 1836 en el Templo de Kirtland, Elías apareció a José Smith y Oliver Cowdery y les confirió "las llaves de la dispensación del evangelio de Abraham". Esta aparición restauró la autoridad de los sellamientos —la capacidad de unir familias por la eternidad — que se había perdido durante la apostasía.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Malaquías 4:5-6', text: 'He aquí, yo os envío el profeta Elías, antes que venga el día de Jehová, grande y terrible. Él hará volver el corazón de los padres hacia los hijos, y el corazón de los hijos hacia los padres, no sea que yo venga y hiera la tierra con maldición.' },
            ...
            { type: 'reflection', prompt: '¿Has sentido el "corazón vuelto hacia tus padres" al explorar tu genealogía o al ir al templo? ¿Qué nombres de antepasados llevas en tu corazón hoy?' },
          ],
        },
      ],
    },
