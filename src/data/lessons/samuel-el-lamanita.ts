      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Helamán 16:2', text: 'Y cuantos creyeron en las palabras de Samuel, éstos salieron a buscar a Nefi; y cuando lo encontraron, le confesaron sus pecados y renunciaron a ellos, y fueron bautizados. Pero la mayor parte no creyó en las palabras de Samuel; y los que no creyeron, se airaron con él; y echaron piedras sobre él; pero el Espíritu del Señor era con él, de manera que no podían herirle.' },
            { type: 'paragraph', text: 'Cuando los nefitas intentaron matar a Samuel con piedras y flechas sin poder herirlo, algunos convirtieron ese signo en testimonio y fueron a buscar a Nefi para bautizarse. Otros lo interpretaron como magia. La misma evidencia produjo conversión en unos y endurecimiento en otros. La protección divina sobre Samuel fue su último acto público — después saltó del muro y regresó a su pueblo, sin ser más mencionado. El profeta fiel hace su trabajo y desaparece.' },
            { type: 'reflection', prompt: '¿Hay un "muro" desde el que Dios te está llamando a hablar — una posición, plataforma o relación desde la que podrías proclamar verdad aunque sepas que no todos la recibirán? ¿Qué te detiene de subir a ese muro?' },
          ],
        },
      ],
    },
