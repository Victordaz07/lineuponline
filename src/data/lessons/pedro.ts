      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'Mateo 4:18-20 describe el llamamiento de Pedro con una economía brutal: "Y él dijo: Venid en pos de mí, y os haré pescadores de hombres. Ellos entonces, dejando al instante las redes, le siguieron." Las redes no eran una metáfora — eran su medio de vida, su identidad, la herencia familiar. El "dejando al instante" es el texto más radical de los cuatro evangelios sobre el discipulado. No planearon. No negociaron. Dejaron.' },
            { type: 'highlight_verse', reference: 'Mateo 16:16-18', text: 'Respondiendo Simón Pedro, dijo: Tú eres el Cristo, el Hijo del Dios viviente. Entonces le respondió Jesús: Bienaventurado eres, Simón, hijo de Jonás, porque no te lo reveló carne ni sangre, sino mi Padre que está en los cielos. Y yo también te digo, que tú eres Pedro, y sobre esta roca edificaré mi iglesia.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'paragraph', text: 'En Mateo 14:28, cuando los discípulos vieron a Jesús caminar sobre el agua, Pedro hizo la petición más audaz de los Evangelios: "Señor, si eres tú, mándame ir a ti sobre las aguas." Jesús dijo: "Ven." Y Pedro bajó del barco. Caminó sobre el agua. Y luego miró el viento, tuvo miedo, y comenzó a hundirse. Este episodio resume toda la vida espiritual de Pedro: capaz de lo imposible cuando mantiene los ojos en Cristo; se hunde cuando los desvía.' },
            { type: 'doctrine_box', title: 'Por qué Pedro ES el Modelo del Discípulo', body: 'Pedro no es el modelo porque sea perfecto — es el modelo porque falla visiblemente y se levanta visiblemente. El discípulo que caminó sobre el agua es el mismo que se hundió. El que confesó a Cristo es el mismo que lo negó. El que lloró amargamente es el mismo que presidió la Iglesia primitiva. Su historia dice: la grandeza espiritual no requiere no caer. Requiere seguir levantándose.' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            { type: 'highlight_verse', reference: 'Lucas 22:61-62', text: 'Entonces, vuelto el Señor, miró a Pedro; y Pedro se acordó de la palabra del Señor... Y Pedro, saliendo fuera, lloró amargamente.' },
            { type: 'paragraph', text: 'Lucas añade un detalle que los otros evangelios omiten: "vuelto el Señor, miró a Pedro." En el momento de la tercera negación, Jesús giró y lo vio. No con juicio — con amor que conoce. Ese miró desencadenó el recuerdo y el arrepentimiento. La restauración de Pedro (Juan 21:15-17) es simétrica perfecta: tres veces negó, tres veces afirmó. "¿Me amas?" "Señor, tú sabes todas las cosas; tú sabes que te amo."' },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          blocks: [
            ...
            { type: 'reflection', prompt: '¿En qué aspecto de tu vida espiritual te identificas más con Pedro: la fe audaz que camina sobre el agua, o la debilidad que se hunde mirando el viento? ¿Cómo ha "mirado" Cristo a ti en tus momentos de fracaso?' },
          ],
        },
      ],
    },
