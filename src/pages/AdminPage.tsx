    ...
    <div className="mx-auto max-w-3xl space-y-6 pb-12">
      ...
      <section className="overflow-hidden rounded-2xl border border-sg-gold/15 bg-navy-mid shadow-sm">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="font-ui text-sm font-semibold text-parchment/85">Descargables</p>
            <p className="font-ui text-xs text-parchment/45">Sube PDFs y guías descargables para compartir</p>
          </div>
          <span className="text-parchment/30">›</span>
        </Link>
      </section>
