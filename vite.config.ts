      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            handler: 'CacheFirst',
            options: { cacheName: 'gfonts-webfonts', expiration: { maxEntries: 10, maxAgeSeconds: 60 * 60 * 24 * 365 } },
          },
          {
            urlPattern: /\/images\/.*/i,
            handler: 'CacheFirst',
            options: { cacheName: 'lesson-images', expiration: { maxEntries: 60, maxAgeSeconds: 60 * 60 * 24 * 30 } },
          },
        ],
      },
    }),
